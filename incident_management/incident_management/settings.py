...
SECRET_KEY = "django-insecure-385(8(m&x)k(7hs*nv+fd-^6v*c)%=$=w#7!anuxb*0*shw0wh"
...
DATABASES = {
    "default": {
        ...
        "NAME": "easy",
        "USER": "postgres",  # Your new PostgreSQL username
        "PASSWORD": "password",  # Your new PostgreSQL password
        "HOST": "localhost",
        "PORT": "5432",
    }
}
